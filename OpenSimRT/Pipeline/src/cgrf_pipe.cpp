...
void Pipeline::Fc::callback(const opensimrt_msgs::CommonTimedConstPtr& message) 
{
...
bool Pipeline::Fc::see(std_srvs::Empty::Request &req, std_srvs::Empty::Response &res)
{
	std::stringstream ss;
